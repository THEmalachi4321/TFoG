...
SMODS.Joker{ --c00lkidd - Milestone II
    key = "c00lkiddmilestoneii",
    config = {
        extra = {
            xmult0 = 5,
            dollars0 = 5
    ...
    loc_txt = {
        ['name'] = 'c00lkidd - Milestone II',
        ['text'] = {
            [1] = '{X:red,C:white}x5{} Mult. {C:money}-$10{} every hand played.',
            [2] = 'When {C:attention}Big{} Blind is selected, creates',
            [3] = '2 helpers. {C:inactive}(Must have room.){}',
