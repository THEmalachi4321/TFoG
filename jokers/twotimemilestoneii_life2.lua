...
SMODS.Joker{ --Two Time - Milestone II (Life 2)
    ...
    loc_vars = function(self, info_queue, card)
        ...
        local new_numerator, new_denominator = SMODS.get_probability_vars(card, 1, card.ability.extra.odds, 'j_tfog_twotimemilestoneii_life2') 
    ...
    calculate = function(self, card, context)
        ...
        context.using_consumeable)   then
            if true then
                if SMODS.pseudorandom_probability(card, 'group_0_8011631d', 1, card.ability.extra.odds, 'j_tfog_twotimemilestoneii_life2', false) then
